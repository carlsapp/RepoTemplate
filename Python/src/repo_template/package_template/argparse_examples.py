...
# In a package, we create a hierarchy of loggers. The console and file loggers are set up in __init__.py.
logger = logging.getLogger(__name__)
logger.setLevel(logging.NOTSET)  # Change the level here if you want a different log level for this module
